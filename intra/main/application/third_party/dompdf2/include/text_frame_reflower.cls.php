...
//       $text = ltrim($text, " \n\r\t");
  ...
  protected function _line_break($text) {
    ...
    $current_line = $this->_block_parent ? $this->_block_parent->get_current_line_box() : null;
    $current_line_width = ($current_line) ? ($current_line->left + $current_line->w + $current_line->right) : 0;
...
//     pre_r("Offset: " . $offset);
  ...
  function reflow(Block_Frame_Decorator $block = null) {
    ...
    $this->_block_parent = $block ? $block : $frame->find_block_parent();
