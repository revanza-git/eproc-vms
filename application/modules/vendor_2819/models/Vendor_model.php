...
class Vendor_model extends CI_Model{
	...
	function get_waiting_list($search='', $sort='', $page='', $per_page='',$is_page=FALSE,$filter=array()){
		// $user = $this->session->userdata('user');
	
		$this->db->select('ms_vendor.id as id,tb_legal.name legal_name,ms_vendor.name name, ms_vendor.edit_stamp last_update, mva.vendor_email email,ms_vendor.npwp_code,mva.vendor_address,mva.vendor_phone,ms_vendor.certificate_no')
