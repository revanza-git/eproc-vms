...
<h1>Selamat Datang, <?php echo $admin['division'];?></h1>
					...
					?>
						<tr><?php //print_r($value);?>
							...
							<td class="actionBlock"><?php if($admin['id_role']!= 2){	?>
								<a href="<?php echo site_url('vendor-data/dpt_print/'.$value['id_vendor'])?>" class="editBtn"><i class="fa fa-search"></i>&nbsp;Lihat Data</a>
								<?php } ?>
							</td>
						</tr>
					<?php 
