...
$config['BASE_LINK.']	= env('BASE_URL', 'http://local.eproc.web.com/app/');
$config['base_app']		= env('BASE_URL', 'http://local.eproc.web.com/app/');
$config['external_url'] = env('EXTERNAL_URL', 'http://local.eproc.web.com/main');
...
$config['admin_intra_url'] = env('ADMIN_INTRA_URL', 'http://local.eproc.web.com/internal');
...
$config['url_eproc_pengadaan_dashboard'] = env('PENGADAAN_DASHBOARD_URL', env('BASE_URL', 'http://local.eproc.web.com/app/') . 'dashboard');
$config['url_eproc_pengadaan_admin'] = env('PENGADAAN_ADMIN_URL', env('BASE_URL', 'http://local.eproc.web.com/app/') . 'admin');
$config['url_eproc_nusantararegas_dashboard'] = env('NUSANTARA_DASHBOARD_URL', env('BASE_URL', 'http://local.eproc.web.com/app/') . 'dashboard');
$config['url_eproc_nusantararegas'] = env('NUSANTARA_BASE_URL', env('BASE_URL', 'http://local.eproc.web.com/app/'));
...
if (is_string($sessSavePath) && strpos($sessSavePath, '://') !== false) {
	$sessSavePath = '';
}
...
$config['cookie_secure']	= env('COOKIE_SECURE', $isHttps);
$config['cookie_httponly'] 	= env('COOKIE_HTTPONLY', TRUE);
