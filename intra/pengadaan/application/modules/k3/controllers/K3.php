...
class K3 extends CI_Controller {
	...
	public function penilaian_k3($id_vendor,$act = 'create',$id_csms=0){
		...
		$k3_all_data = $this->km->get_k3_all_data($id_vendor);
		...
		$data['value_k3']=$this->km->get_penilaian_value($id_vendor, $csms_file_id);	
	...
	public function export_excel(){
		...
		$data = $this->km->get_k3_vendor($search, $sort, '', '', FALSE, $filter);
		$title = "Data CSMS";
