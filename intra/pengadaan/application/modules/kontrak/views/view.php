		...
		<table>
			...
			<tr class="input-form">
				...
				<td>
					: <?php 
						$tipe = '';
						if(isset($tipe_pengadaan) && $tipe_pengadaan == 'barang') {
							$tipe = 'Barang';
						} else if(isset($tipe_pengadaan) && $tipe_pengadaan == 'jasa_konstruksi') {
							$tipe = 'Jasa Konstruksi';
						} else if(isset($tipe_pengadaan) && $tipe_pengadaan == 'jasa_konsultasi') {
							$tipe = 'Jasa Konsultasi';
						} else if(isset($tipe_pengadaan) && $tipe_pengadaan == 'jasa_lainnya') {
							$tipe = 'Jasa Lainnya';
						} else if(isset($tipe_pengadaan) && $tipe_pengadaan == 'jasa_konsultan_konstruksi') {
							$tipe = 'Jasa Konsultan Perencana/Pengawas Konstruksi';
						} else if(isset($tipe_pengadaan) && $tipe_pengadaan == 'jasa_konsultan_non_konstruksi') {
			...
			<tr  class="input-form">
				...
				<td>:
					...
					echo isset($evaluation_method) && isset($penilaian[$evaluation_method]) ? $penilaian[$evaluation_method] : 'Tidak Diketahui';
					?>
				</td>
			</tr>
			<tr  class="input-form">
