...
<head>
	...
	<link rel="icon" href="<?php echo base_url('assets/images/icon-nr.png?v='.@filemtime(FCPATH.'assets/images/icon-nr.png')); ?>" />
    <link rel="stylesheet" href="assets/styles/fontawesome5.6.3/css/all.css" />
    <style>
		.field{
			margin-top: 5px;
...
<body>
				...
				<div class="form-login">
					<div class="group-start">
						<div class="logo-wrapper">
							<img src="<?= base_url().'assets/images/logo-nr.png?v='.@filemtime(FCPATH.'assets/images/logo-nr.png') ?>" alt="">
						</div>
	...
	<link rel="stylesheet" href="<?= base_url().'assets/js/jquery-ui/development-bundle/themes/base/jquery-ui.css' ?>" />
	<script src="<?= base_url().'assets/js/jquery-ui/js/jquery-ui-1.10.0.custom.min.js' ?>"></script>
