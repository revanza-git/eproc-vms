...
<!-- <div class="btnTopGroup clearfix">
	...
	<a href="<?php echo site_url('blacklist/tambah/'.(isset($id_blacklist) ? $id_blacklist : ''))?>" class="btnBlue"><i class="fa fa-plus"></i>Tambah</a>
		...
		?>
				...
				<tr style="<?php echo $yellow;?>">
					...
					<td class="actionBlock">
						...
						<a href="<?php echo site_url('vendor-data/dpt_print/'.$value['id_vendor'])?>" class="editBtn lihatData">
