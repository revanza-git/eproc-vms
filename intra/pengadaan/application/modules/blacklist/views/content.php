	...
	<table class="tableData remark">
		...
		<thead>
			...
			<tr>
				...
				<td style="width: 120px"><a href="?<?php echo $this->utility->generateLink('sort','desc')?>&sort=<?php echo (isset($sort['category']) && $sort['category'] == 'asc') ? 'desc' : 'asc'; ?>&by=category">Kategori<i class="fa fa-sort-<?php echo (isset($sort['category']) && $sort['category'] == 'asc') ? 'desc' : 'asc'; ?>"></i></a></td>
		...
		?> 
				...
				<tr style="<?php echo $yellow;?>">
					...
					<td class="actionBlock">
							<a href="<?php echo site_url('vendor-data/dpt_print/'.$value['id_vendor'])?>" class="editBtn printSerti">
