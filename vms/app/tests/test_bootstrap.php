...
echo "<p>Testing each step of CodeIgniter loading...</p>";
...
echo "<h2>Step 2: File Structure Test</h2>";
$required_files = [
...
echo "<h2>Step 3: Environment Loading Test</h2>";
try {
...
// Step 4: Test CodeIgniter bootstrap step by step
...
echo "<h2>Memory and Execution Status</h2>";
