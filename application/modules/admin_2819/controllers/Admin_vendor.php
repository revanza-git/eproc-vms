...
array('table'=>'ms_vendor|need_approve|status_dpt' ,'type'=>'dropdown','label'=> 'Status'),
	...
	public function waiting_list(){
		...
		$data['pagination'] 	= $this->utility->generate_page('admin/admin_vendor/waiting_list',$sort, $per_page, $this->vm->get_waiting_list($search, $sort, '','',FALSE));
		$data['sort'] 			= $sort;
		$data['list'] 			= $this->vm->get_waiting_list($search, $sort, $page, $per_page,TRUE,$filter);
