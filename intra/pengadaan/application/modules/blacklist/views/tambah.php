	...
	<form method="POST" enctype="multipart/form-data" style="float:left; width:500px !important; display:inline-block;">
		...
		<table>
			...
			<tr class="input-form">
				...
				<td>
					<input type="input" placeholder="Cari Vendor" name="q" class="suggestionInput" id="vendor_name" value="<?php echo isset($vendor['vendor_name']) ? $vendor['vendor_name'] : '';?>" <?php echo (!empty($vendor['vendor_name'])) ? 'disabled' : '';?>>
					<input type="hidden" id="id_vendor" name="id_vendor" value="<?php echo isset($vendor['id_vendor']) ? $vendor['id_vendor'] : '';?>">
