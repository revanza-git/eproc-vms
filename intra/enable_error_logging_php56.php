<?php
/**
 * Enable Error Logging Integration (PHP 5.6 Compatible)
 * Include this file at the top of main/index.php to enable error logging
 */

// Include the PHP 5.6 compatible error logger
require_once(__DIR__ . '/error_logger_php56.php');
...
echo "<!-- Error logging enabled (PHP 5.6 compatible) -->\n";
?> 